...
"Software stack" to _105a_ (from the 107 default in Jan. 2026),
...
~~~
git clone https://github.com/cms-jet/JMEDAS.git -b DASJan2026 --single-branch --depth=1
cd JMEDAS/notebooks/DAS/
~~~
{: .language-bash}

> ## Remember
> Once you clone the repository, using the `DASJan2026` branch, the exercise notebooks are located
