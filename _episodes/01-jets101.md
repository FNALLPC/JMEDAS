...
Only particles in "color singlet” state are observed in nature, due to color confinement. The kinematic properties of the jet are intended to resemble that of the initial partons. What we try to do with our detectors is to measure the decay products to get access to particle/parton level:
